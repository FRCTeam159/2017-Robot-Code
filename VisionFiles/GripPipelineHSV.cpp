#include "GripPipelineHSV.h"
/**
* Initializes a GripPipelineHSV.
*/

namespace grip {

GripPipelineHSV::GripPipelineHSV() {
}
/**
...
*
*/
void GripPipelineHSV::process(cv::Mat source0){
	//Step HSV_Threshold0:
	//input
	cv::Mat hsvThresholdInput = source0;
	double hsvThresholdHue[] = {74.46043165467627, 101.67235494880548};
	double hsvThresholdSaturation[] = {222.4370503597122, 255.0};
	double hsvThresholdValue[] = {52.74280575539568, 133.1569965870307};
 ...
 */
void GripPipelineHSV::setsource0(cv::Mat &source0){
 ...
 */
cv::Mat* GripPipelineHSV::gethsvThresholdOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* GripPipelineHSV::getfindContoursOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* GripPipelineHSV::getconvexHullsOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* GripPipelineHSV::getfilterContoursOutput(){
	 ...
	 */
	void GripPipelineHSV::hsvThreshold(cv::Mat &input, double hue[], double sat[], double val[], cv::Mat &out) {
	 ...
	 */
	void GripPipelineHSV::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
	 ...
	 */
	void GripPipelineHSV::convexHulls(std::vector<std::vector<cv::Point> > &inputContours, std::vector<std::vector<cv::Point> > &outputContours) {
